...
{
	static constexpr uint16_t I2C_REG_PRER_LO = 0x0;
	static constexpr uint16_t I2C_REG_PRER_HI = 0x1 << 2;
	static constexpr uint16_t I2C_REG_CTR	  = 0x2 << 2;
	static constexpr uint16_t I2C_REG_TXR_RXR = 0x3 << 2;
	static constexpr uint16_t I2C_REG_CR_SR	  = 0x4 << 2;

	static constexpr uint16_t I2C_CTR_EN_BIT  = 0x7;
	static constexpr uint16_t I2C_CTR_IEN_BIT = 0x6;
	...
	{
	  public:
		I2C(uint64_t base, runner::Machine& cpu, fdt_node* fdt);
		static std::shared_ptr<I2C> init_auto(runner::Machine& cpu);
