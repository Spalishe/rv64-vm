...
{
	// Do not use this keyboard, use HID_USB_Keyboard instead
	// This file will exist in case someone wanna get example on hov HIDOverI2C works
	struct [[deprecated]] HID_Keyboard : HIDOverI2C
	{
	  public:
