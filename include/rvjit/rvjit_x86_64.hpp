...
namespace rv64vm::jit
{
	...
	// ABI contract:
	// rdi = JIT_::rv64vm::runner::HartContext*
	// r12 = ctx
	// r13 = regs*
...
#define NO_INDEX 0xFF
	...
	inline void JIT_Emitter::inst_emit_r_type(::rv64vm::runner::Hart& h, ::rv64vm::runner::InstructionData& inst, JIT_Block& blk, bool optimize_if_rsz, ROpFunction emit_op, uint64_t pc, void* tmp)
	{
	...
	inline void JIT_Emitter::inst_emit_i_type(::rv64vm::runner::Hart& h, ::rv64vm::runner::InstructionData& inst, JIT_Block& blk, bool optimize_if_rsz, IOpFunction emit_op, uint64_t pc, void* tmp)
	{
		blk.inst_addr_jmp[blk.size] = blk.byte_pos;
		if(inst.rd == 0)
		{
	...
	inline void JIT_Emitter::inst_emit_s_type(::rv64vm::runner::Hart& h, ::rv64vm::runner::InstructionData& inst, JIT_Block& blk, SOpFunction emit_op, uint64_t pc, void* tmp)
	{
		blk.inst_addr_jmp[blk.size] = blk.byte_pos;
	...
	inline void JIT_Emitter::inst_emit_b_type(::rv64vm::runner::Hart& h, ::rv64vm::runner::InstructionData& inst, JIT_Block& blk, BOpFunction emit_op, uint64_t pc, void* tmp)
	{
		blk.inst_addr_jmp[blk.size] = blk.byte_pos;
	...
	inline void JIT_Emitter::inst_emit_j_type(::rv64vm::runner::Hart& h, ::rv64vm::runner::InstructionData& inst, JIT_Block& blk, JOpFunction emit_op, uint64_t pc, void* tmp)
	{
		blk.inst_addr_jmp[blk.size] = blk.byte_pos;
	...
	inline void JIT_Emitter::inst_emit_u_type(::rv64vm::runner::Hart& h, ::rv64vm::runner::InstructionData& inst, JIT_Block& blk, UOpFunction emit_op, uint64_t pc, void* tmp)
	{
		blk.inst_addr_jmp[blk.size] = blk.byte_pos;
		if(inst.rd == 0)
		{
