...
{
	HIDOverI2C::HIDOverI2C(runner::Machine& cpu, fdt_node* fdt, std::vector<uint8_t> report_desc, uint16_t input_report_size) : I2CSlave(cpu.get_mmio()->get<PLIC>().get()->acquire_irq(), HID_I2C_BUFFER_SIZE),
